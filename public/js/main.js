...
$('[data-countdown]').each(function () {
	...
	$this.countdown(finalDate, function (event) {
		$this.html(event.strftime('<div class="time-count day"><span>%D</span><span>:</span></div><div class="time-count hour"><span>%H</span><span>:</span></div><div class="time-count min"><span>%M</span><span>:</span></div><div class="time-count sec"><span>%S</span></div>'));
	});
});
