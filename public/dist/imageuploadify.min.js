		...
		this.each(function() {
			...
			const readingFile = (id, file) => {
                ...
                container.click(function(){
                    var img = $(this).children().get(2);
                    var img =  $(img).attr('src')
                    console.log(img)
                    $('.img_modal').html("<div class='ff_fileupload_dialog_background'><div class='ff_fileupload_dialog_main'><img src='"+ img +"'><button  class='img_modal_close'><span aria-hidden='true'>&times;</span></button></div></div>")
                });
                // clos img modal
			...
			button.mouseenter(function onMouseEnter(event) {
				button.css("background", "#fc9135").css("color", "white");
			}).mouseleave(function onMouseLeave() {
				button.css("background", "#4eb92d").css("color", "white");
			});
			...
			$(self).closest("form").on("submit", function(event) {
				...
				for (var i = 0; i < totalFiles.length; i++) {
                    formData.append(i, totalFiles[i].file);
				}
