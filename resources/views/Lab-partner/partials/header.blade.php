    ...
    <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
        ...
        <div class="row">
            <div class="col-12 logo_col_color">
                <a class="pl-0 ml-0 text-center" href="{{ URL::asset('lab-partner-dashboard') }}">
                    <div class="logo_des">
                        <div class="p-1">
                             {{-- @php  var_dump(get_collection_boy()->image);die; @endphp --}}
                            <img src="{{ URL::asset('admin/img/loginimg/admin_img3.png') }}" alt="logo" class="logo_img">
                        </div>
                        <h5 class="m-0 p-0">{{ ucwords(session()->get('lab_partner_name'))}}</h5>
                    </div>
                </a>
        ...
        <ul class="page accordion ms-main-aside fs-14" id="side-nav-accordion">
            <!-- Dashboard -->
            <li class="menu-item">
                <a href="{{ URL::asset('lab-partner-dashboard') }}"> <span><i class="fas fa-home fs-16"></i>Dashboard </span></a>
            </li>
            <!-- Dashboard -->
            <!-- order -->
            <li class="menu-item">
                <a href="{{ URL::asset('lab-partner/order') }}"> <span><i class="fas fa-list fs-16"></i>Orders</span></a></a>
            </li>
            <!-- order -->
        </ul>
...
@include('Lab-partner.partials.menu')
