...
<nav class="navbar ms-navbar">
    ...
    <div class="logo-sn logo-sm ms-d-block-sm">
        <a class="pl-0 ml-0 text-center navbar-brand mr-0" href="{{ URL::asset('collection-boy-dashboard') }}"><img src="{{ URL::asset('admin/img/costic/logo.png') }}" alt="logo"> </a>
    </div>
    ...
    <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
            <a href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <img class="ms-user-img ms-img-round float-right" src="{{ URL('upload/blood_boy') }}/{{ get_collection_boy()->image; }}" alt="people">
            </a>
            <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                <li class="dropdown-menu-header">
                    <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, {{ ucwords(get_collection_boy()->name)}}</span></h6>
                </li>
                <li class="dropdown-divider"></li>
                ...
                <li class="dropdown-menu-footer">
                    <a class="media fs-14 p-2" href="{{url('collection-boy-logout')}}">
