        ...
        <div class="container custom-container">
            <div class="row ">
                ...
                <div class="col-md-8 col-sm-12 order_details">
                    ...
                    <div class="col-12">
                        <div class="row order-row-item">
                            ...
                            <div class="col-9">
                                ...
                                @endif
                                <a href="{{url('invoice')}}/{{$orders->order_number}}" target="_blank"class="btn btn-sm  float-right _header_btn">
                        ...
                        <div class="row order-row-item">
                            ...
                            <div class="col-9">
                                ...
                                <span class="lable">Online Payment</span>
                                @endif
                            </div>
                        </div>
                        <div class="row order-row-item">
                    ...
                    <div class="col-12 order_details_number  pt-20">
                        @if(count($orders_items_lab_tests) > 0)
                        <h3 class="border-0 m-0">Lab Tests</h3>
                        @endif
                        @if(count($orders_items_packages) > 0)
                        <h3 class="border-0 m-0">Packages</h3>
                        @endif
                        @if(count($orders_items_prescription) > 0)
                                ...
                                <tbody>
                                    @if(count($orders_items_packages) > 0)
                                        ...
                                        @foreach($orders_items_packages as $orders_items_package)
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$orders_items_package->item_title}}</td>
                                                <td>₹{{$orders_items_package->item_price}}</td>
                                                {{-- status --}}
                                                @if($orders->current_status == 'pending')
                                                <td>Pending</td>
                                                @endif
                                                ...
                                                <td>{{time_ago($orders_items_package->updated_date)}}</td>
                                                <td></td>
                                            </tr>
                                        <?php $i++?>
                                        @endforeach
                                    ...
                                    @if(count($orders_items_lab_tests) > 0)
                                        <?php $i= 1; ?>
                                        @foreach($orders_items_lab_tests as $orders_items_lab_test)
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$orders_items_lab_test->item_title}}</td>
                                                <td>₹{{$orders_items_lab_test->item_price}}</td>
                                                {{-- status --}}
                                                @if($orders->current_status == 'pending')
                                                <td>Pending</td>
                                                @endif
                                                ...
                                                <td>Cancelled</td>
                                                @endif
                                                <td>{{time_ago($orders_items_lab_test->updated_date)}}</td>
                                                <td></td>
                                            </tr>
                                        <?php $i++?>
                                        @endforeach
                                    ...
                                    @if(count($orders_items_prescription) > 0)
                                        <?php $i= 1; ?>
                                        @foreach($orders_items_prescription as $orders_items_prescription)
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$orders_items_prescription->item_title}}</td>
                                                <td>₹{{$orders_items_prescription->item_price}}</td>
                                                {{-- status --}}
                                                @if($orders->current_status == 'pending')
                                                <td>Pending</td>
                                                @endif
                                                ...
                                                <td>Cancelled</td>
                                                @endif
                                                <td>{{time_ago($orders_items_prescription->updated_date)}}</td>
