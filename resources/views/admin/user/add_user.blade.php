            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-arrow has-gap has-bg">
                        ...
                        <li class="breadcrumb-item" aria-current="page"> <a href="{{url('admin/customer')}}">Customer</a>
                        </li>
            ...
            <div class="col-md-10">
                <div class="ms-panel ">
                    ...
                    <div class="ms-panel-body">
                        <form class="needs-validation validation-fill user-form" action="{{url('admin/user/add-post')}}" method="POST" enctype="multipart/form-data" novalidate>
                            <div class="error"></div>
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control number Number"  name="contact_number" minlength="10" maxlength="12" id="validationCustom5" placeholder="Contact Number"
                                         required>
                                        <div class="invalid-feedback">Please provide a valid Contact Number.</div>
                                    </div>
                                </div>
