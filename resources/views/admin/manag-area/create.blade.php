            ...
            <div class="col-md-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-arrow has-gap has-bg">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manag Area Add</li>
                    </ol>
                </nav>
            </div>
            <div class="col-md-12">
                <div class="ms-panel ">
                    <div class="ms-panel-header">
                        <h6>Manag Area Add</h6>
                    </div>
                    <div class="ms-panel-body">
                        <form class="needs-validation validation-fill" action="{{url('admin/manag-area-add-post')}}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control"  name="taluka" id="validationCustom3" placeholder="Taluka"
                                         required>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control Number" maxlength="6" name="pincode" id="validationCustom4" placeholder="Pincode"
                                         required>
