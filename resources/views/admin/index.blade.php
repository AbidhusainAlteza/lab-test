...
<main class="body-content">
    ...
    <div class="ms-content-wrapper">
        <div class="row">
            <div class="col-md-12">
                <h1 class="db-header-title">Welcome, {{ucwords(session('user_name'))}}</h1>
            </div>
                    ...
                    <a href="{{url('admin/administrator')}}">
                        <div class="ms-card-body media">
                            <div class="media-body">
                                <h6>Admin</h6>
                                <p class="ms-card-change" id="admin_count"><i class="fas fa-arrow-up"></i> {{isset($admin)?$admin:'0'}}</p>
                            </div>
                        </div>
                ...
                <div class="ms-card card-gradient-warning ms-widget ms-infographics-widget">
                    <a href="{{url('admin/vendor')}}">
                        <div class="ms-card-body media">
                            <div class="media-body">
                                <h6>All Vendors</h6>
                                <p class="ms-card-change" id="vendor_count"><i class="fas fa-arrow-up"></i> {{isset($vendor)?$vendor:'0'}}</p>
                            </div>
                        </div>
                ...
                <div class="ms-card card-gradient-secondary ms-widget ms-infographics-widget">
                    <a href="{{url('admin/customer')}}">
                        <div class="ms-card-body media">
                            <div class="media-body">
                                <h6>All Customer</h6>
                                <p class="ms-card-change" id='user_count'><i class="fas fa-arrow-up"></i> {{isset($user)?$user:'0'}}</p>
                            </div>
                        </div>
                        <i class="fas fa-users"></i>
                    </a>
                ...
                <div class="ms-card card-gradient-info ms-widget ms-infographics-widget">
                    <a href="{{url('admin/order')}}">
                        <div class="ms-card-body media">
                            <div class="media-body">
                                <h6>All Order</h6>
                                <p class="ms-card-change"><i class="fas fa-arrow-up"></i> {{$order}}</p>
                            </div>
                        </div>
